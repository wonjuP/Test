...
.idBox { border:1px solid black; width:240px; }
.pwBox { border:1px solid black; width:240px; }
...
#memberjoin {
	...
	background-color: #e9faf6; text-align: center; font-weight: 
	bold; margin: 0 0 50px 50px; 
}
#uid, #pwd { border:none; margin-bottom:10px; }
#idmargin{ margin-bottom:8px; }
#mi_id { width:100px; height:30px; margin-left:70px; }
</style>
</head>
<body>
