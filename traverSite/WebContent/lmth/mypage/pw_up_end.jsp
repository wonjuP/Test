...
.pw1 { font-size:16px; font-weight:bold; margin-left:130px; }
.pw2 { font-size:16px; font-weight:bold; margin-left:240px; }
   ...
   <div class="container-default_box">
	...
	<div class="main_box">
		...
		<div class="changePwBox">
			<br /><br /><br /><br /><br /><br />
			<span class="pw1">회원님의 비밀번호 변경이 <span style="color:#3f6; font-weight:bold;">완료</span>되었습니다.</span><br /><br /><br />
			<span class="pw2">감사합니다.</span>
		</div>
	</div>
