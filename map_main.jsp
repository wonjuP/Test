...
<div class="right-side open">
	...
	<% if (isHaveLodging) { %>
		...
		for(int i = 0; i < placeList.size() ; i ++) { 
			PlaceInfo pi = placeList.get(i);
			if (pi.getPi_ctgr().equals("1")) {	// 숙소면
		%>
				<div class="place" onclick="listBox();">
	...
	<% if (isHaveRestaurant) {  %>
		...
		for(int i = 0; i < placeList.size() ; i ++) { 
			PlaceInfo pi = placeList.get(i);
			if (pi.getPi_ctgr().equals("2")) { // 음식점이면
		%>
				<div class="place" onclick="listBox();">
					<div class="place__img">
						<img src="#" alt="" />
	...
	<% if (isHaveTourist) {  %>
		...
		for(int i = 0; i < placeList.size() ; i ++) { 
			PlaceInfo pi = placeList.get(i);
			if (pi.getPi_ctgr().equals("3")) {	// 관관지이면
		%>
				<div class="place" onclick="listBox();">
					<div class="place__img">
						<img src="#" alt="" />
...
%>
    ...
    var listBoxes = document.querySelector('div.place'); 
   
 	listBoxes.addEventListener('mouseover', function() {
 		listBoxes.style.background = '#eff7ff';
 	});	
 	listBoxes.addEventListener('mouseout', function() {
